...
# Add lockout columns to the auth_credentials table
message("Running account lockout schema migration...")
add_column_if_missing(con, "auth_credentials", "failed_attempts", "INTEGER DEFAULT 0")
add_column_if_missing(con, "auth_credentials", "locked_until", "TIMESTAMP WITH TIME ZONE")
