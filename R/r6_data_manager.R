#' @title R6 Class to store and process data
#' @description
...
DataManager <- R6::R6Class(
  ...
  public = list(
    ...
    #' @field chart_file_path
    #' Temporary JPEG path generated by async chart rendering.
    chart_file_path = NULL,
    ...
    #' @description
    #' Resolve and store chart location metadata on the main process.
    #' @param country Character. Full country name.
    #' @param city Character. City name.
    #' @return Invisibly returns \code{self}.
    set_chart_location = function(country, city) {
      loc_data <- lookup_city_data(country, city)
      self$horoscope_country <- country
      self$horoscope_city <- city
